...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: DashboarddWidget.routeName,
          path: DashboarddWidget.routePath,
          builder: (context, params) => DashboarddWidget(),
        ),
        FFRoute(
          name: CadastroFuncionariosWidget.routeName,
          path: CadastroFuncionariosWidget.routePath,
          builder: (context, params) => CadastroFuncionariosWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => EditarProdutoWidget(
            produtoSelecionado: params.getParam(
              'produtoSelecionado',
              ParamType.JSON,
            ),
          ),
        ...
        FFRoute(
          name: MembrosWidget.routeName,
          path: MembrosWidget.routePath,
          builder: (context, params) => MembrosWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: EditarPratosdoDiaWidget.routeName,
          path: EditarPratosdoDiaWidget.routePath,
          builder: (context, params) => EditarPratosdoDiaWidget(
