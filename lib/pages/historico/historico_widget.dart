                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FutureBuilder<ApiCallResponse>(
                            future: HistoricoPedidosCall.call(),
                            builder: (context, snapshot) {
                              ...
                              final listViewHistoricoPedidosResponse =
                                  snapshot.data!;

                              return Builder(
                                builder: (context) {
                                  final pedidos = getJsonField(
                                    listViewHistoricoPedidosResponse.jsonBody,
                                    r'''$''',
                                  ).toList();
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return Builder(
                                                                      builder:
                                                                        ...
                                                                        final itens =
                                                                            getJsonField(
                                                                          listViewPuxarItensPedidoIDResponse
                                                                              .jsonBody,
                                                                          r'''$''',
                                                                        ).toList();
                                                                            ...
                                                                            return Text(
                                                                              valueOrDefault<String>(
                                                                                '${getJsonField(
                                                                                  ...
                                                                                  itensItem,
                                                                                  r'''$._item.qtd''',
                                                                                ).toString()})|${functions.gerarMoeda(getJsonField(
                                                                                  itensItem,
                                                                                  r'''$.subtotal''',
                                                                                ))}',
                                                                                'nome',
