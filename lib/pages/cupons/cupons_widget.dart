                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FutureBuilder<ApiCallResponse>(
                                    future: BuscaPratosdoDiaCall.call(),
                                    builder: (context, snapshot) {
                                      ...
                                      final listViewBuscaPratosdoDiaResponse =
                                          snapshot.data!;

                                      return Builder(
                                        builder: (context) {
                                          final meuspratos = getJsonField(
                                            listViewBuscaPratosdoDiaResponse
                                                .jsonBody,
                                            r'''$[:]''',
                                          ).toList();
                                          ...
                                          return ListView.separated(
                                            ...
                                            itemCount: meuspratos.length,
                                            separatorBuilder: (_, __) =>
                                                SizedBox(height: 10.0),
                                            itemBuilder:
                                                (context, meuspratosIndex) {
                                              final meuspratosItem =
                                                  meuspratos[meuspratosIndex];
                                              return Container(
                                                height: 80.0,
                                                decoration: BoxDecoration(),
                                                child: Column(
                                            ...
                                            children: [
                                              ...
                                              FutureBuilder<ApiCallResponse>(
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  final listViewGetCouponsResponse =
                                                      snapshot.data!;
