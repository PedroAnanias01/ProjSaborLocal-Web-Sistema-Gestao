...
class EditarProdutoWidget extends StatefulWidget {
  ...
  final dynamic produtoSelecionado;

  static String routeName = 'EditarProduto';
...
class _EditarProdutoWidgetState extends State<EditarProdutoWidget> {
  ...
  void initState() {
    ...
    _model.textFieldNMprodTextController ??= TextEditingController(
        text: getJsonField(
      widget.produtoSelecionado,
      r'''$.nome''',
    ).toString());
    _model.textFieldNMprodFocusNode ??= FocusNode();

    _model.textFieldPRCprodTextController ??= TextEditingController(
        text: getJsonField(
      widget.produtoSelecionado,
      r'''$.preco''',
    ).toString());
    _model.textFieldPRCprodFocusNode ??= FocusNode();

    _model.textFieldDESCprodTextController ??= TextEditingController(
        text: getJsonField(
      widget.produtoSelecionado,
      r'''$.descricao''',
    ).toString());
    _model.textFieldDESCprodFocusNode ??= FocusNode();
  }
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Container(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                      .textFieldNMprodTextController,
                                                  focusNode: _model
                                                      .textFieldNMprodFocusNode,
                                                  autofocus: false,
                                                  enabled: true,
                                                  obscureText: false,
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: Padding(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: TextFormField(
                                                          controller: _model
                                                              .textFieldPRCprodTextController,
                                                          focusNode: _model
                                                              .textFieldPRCprodFocusNode,
                                                          autofocus: false,
                                                          enabled: true,
                                                          obscureText: false,
                                                          decoration:
                                                  ...
                                                  FlutterFlowDropDown<String>(
                                                    controller: _model
                                                            .dropDownCATprodValueController ??=
                                                        FormFieldController<
                                                            String>(
                                                      _model.dropDownCATprodValue ??=
                                                          getJsonField(
                                                        widget
                                                            .produtoSelecionado,
                                                        r'''$.categoria''',
                                            ...
                                            Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .textFieldDESCprodTextController,
                                                focusNode: _model
                                                    .textFieldDESCprodFocusNode,
                                                autofocus: false,
                                                enabled: true,
                                                obscureText: false,
                                                decoration: InputDecoration(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        _model.apiResultEDTprod =
                                            await EditarProdutoCall.call(
